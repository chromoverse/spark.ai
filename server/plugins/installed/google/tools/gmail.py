...
class EmailListTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "List emails from the mailbox with optional label and query filters"
    ...
    PARAMS_SCHEMA = {
        ...
        "query": {
            ...
            "required": False,
            "default": "",
            "description": "Gmail search query e.g. 'is:unread from:boss@corp.com'"
        },
        "max_results": {
            "type": "integer",
            "required": False,
    ...
    OUTPUT_SCHEMA = {
        ...
        "data": {
            "emails": {
                "type": "array",
                "description": "List of email summaries (id, thread_id, labels, snippet, from, to, subject, date, is_read)"
            },
...
class EmailReadTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Fetch the full content (headers, body, attachments) of a single email by ID"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_id": {
            "type": "string",
    ...
    OUTPUT_SCHEMA = {
        ...
        "data": {
            ...
            "attachments": {
                "type": "array",
                "description": "Metadata only — [{filename, mime_type, attachment_id, size_bytes}]"
            }
        },
        "error": {"type": "string"}
    }
    EXAMPLES = [
        {"user_utterance": "email read"}
    ]
...
class EmailSendTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Compose and send a new email"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "to": {
            "type": "string",
...
class EmailReplyTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Reply to an existing email within the same thread"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_id": {
            "type": "string",
        ...
        "subject": {
            "type": "string",
            "required": False,
            "description": "Override subject (defaults to Re: <original>)"
        },
        "user_id": {
            "type": "string",
            "required": True,
    ...
    EXAMPLES = [
        {"user_utterance": "email reply"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "reply"]
    TOOL_CATEGORY = "communication"
...
class EmailDeleteTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Permanently delete an email — IRREVERSIBLE. Use email_trash for a safer alternative"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_id": {
            "type": "string",
    ...
    EXAMPLES = [
        {"user_utterance": "email delete"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "delete"]
    TOOL_CATEGORY = "communication"
...
class EmailTrashTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Move an email to Trash (recoverable within 30 days)"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_id": {
            "type": "string",
    ...
    EXAMPLES = [
        {"user_utterance": "email trash"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "trash"]
    TOOL_CATEGORY = "communication"
...
class EmailMarkReadTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Mark one or more emails as read"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_ids": {
            "type": "array",
    ...
    OUTPUT_SCHEMA = {
        "success": {"type": "boolean"},
        "data": {
            "marked_read": {"type": "array"},
            "count": {"type": "integer"}
        },
        "error": {"type": "string"}
    }
    EXAMPLES = [
        {"user_utterance": "email mark read"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "mark", "read"]
    TOOL_CATEGORY = "communication"
...
class EmailMarkUnreadTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Mark one or more emails as unread"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_ids": {
            "type": "array",
    ...
    OUTPUT_SCHEMA = {
        "success": {"type": "boolean"},
        "data": {
            "marked_unread": {"type": "array"},
            "count": {"type": "integer"}
        },
        "error": {"type": "string"}
    }
    EXAMPLES = [
        {"user_utterance": "email mark unread"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "mark", "unread"]
    TOOL_CATEGORY = "communication"
...
class EmailSearchTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Search emails using full Gmail search syntax"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "query": {
            "type": "string",
            "required": True,
            "description": "Gmail search query e.g. 'from:alice subject:invoice has:attachment'"
        },
        "max_results": {
            "type": "integer",
            "required": False,
    ...
    EXAMPLES = [
        {"user_utterance": "email search"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "search"]
    TOOL_CATEGORY = "communication"
...
class EmailLabelTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Add or remove labels on a single email (supports system labels like STARRED, IMPORTANT and custom ones)"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_id": {
            "type": "string",
    ...
    EXAMPLES = [
        {"user_utterance": "email label"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "label"]
    TOOL_CATEGORY = "communication"
...
class EmailMoveTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Move an email to a different label/folder by adding the destination label and removing source labels"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "message_id": {
            "type": "string",
        ...
        "destination": {
            "type": "string",
            "required": True,
            "description": "Destination label name or ID (e.g. 'Work', 'Receipts')"
        },
        "remove_from": {
            "type": "array",
            "required": False,
            "default": ["INBOX"],
            "description": "Labels to remove (defaults to INBOX)"
        },
        "user_id": {
            "type": "string",
            "required": True,
    ...
    OUTPUT_SCHEMA = {
        ...
        "data": {
            ...
            "removed_from": {"type": "array"}
        },
        "error": {"type": "string"}
    }
    EXAMPLES = [
        {"user_utterance": "email move"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "move"]
    TOOL_CATEGORY = "communication"
...
class EmailOrganizeTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Bulk-organize emails matching a search query. Actions: mark_read | mark_unread | archive | trash | label:<name> | unlabel:<name>"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "query": {
            "type": "string",
            "required": True,
            "description": "Gmail search query to select target emails"
        },
        "action": {
            "type": "string",
            "required": True,
            "description": "mark_read | mark_unread | archive | trash | label:<name> | unlabel:<name>"
        },
        "max_messages": {
            "type": "integer",
            "required": False,
            "default": 50,
            "description": "Safety cap on how many emails are affected"
        },
        "user_id": {
            "type": "string",
            "required": True,
    ...
    EXAMPLES = [
        {"user_utterance": "email organize"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "organize"]
    TOOL_CATEGORY = "communication"
...
class EmailLabelsListTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "List all Gmail labels (system + user-created) with unread counts"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "user_id": {
            "type": "string",
    ...
    OUTPUT_SCHEMA = {
        ...
        "data": {
            "labels": {
                "type": "array",
                "description": "[{id, name, type, messages_total, messages_unread}]"
            },
            "total": {"type": "integer"}
        },
        "error": {"type": "string"}
    ...
    EXAMPLES = [
        {"user_utterance": "email labels list"}
    ]
    SEMANTIC_TAGS = ["gmail", "email", "labels", "list"]
    TOOL_CATEGORY = "communication"
