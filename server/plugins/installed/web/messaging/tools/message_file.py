...
class MessageFileTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Send a document or file (PDF, ZIP, DOCX, etc.) to a contact"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "contact": {
            "type": "string",
            "required": True,
            "description": "Contact name to send file to"
        },
        "file_path": {
            "type": "string",
            "required": True,
        ...
        "caption": {
            ...
            "required": False,
            "default": "",
            "description": "Optional caption with the file"
        },
        "platform": {
            "type": "string",
            "required": False,
    ...
    EXAMPLES = [
        {"user_utterance": "message file"}
    ]
    SEMANTIC_TAGS = ["messaging", "message", "file"]
