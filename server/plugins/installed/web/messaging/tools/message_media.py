...
class MessageMediaTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Send a photo or video to a contact"
    EXECUTION_TARGET = "server"
    PARAMS_SCHEMA = {
        "contact": {
            "type": "string",
            "required": True,
            "description": "Contact name to send media to"
        },
        "media_path": {
            "type": "string",
            "required": True,
            "description": "Absolute path to photo or video"
        },
        "caption": {
            "type": "string",
            "required": False,
            "default": "",
            "description": "Optional caption with the media"
        },
        "platform": {
            "type": "string",
            "required": False,
    ...
    EXAMPLES = [
        {"user_utterance": "message media"}
    ]
    SEMANTIC_TAGS = ["messaging", "message", "media"]
