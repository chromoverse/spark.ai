...
class WebResearchTool(BaseTool):
    ...
    TOOL_DESCRIPTION = (
        "Performs deep web research by searching, scraping top results, "
    ...
    PARAMS_SCHEMA: Dict[str, Any] = {
        ...
        "max_results": {"type": "integer", "required": False, "default": 3},
    ...
    async def _execute(self, inputs: Dict[str, Any]) -> ToolOutput:
        ...
        # 3. Summarize — import from sibling ai plugin
        from plugins.installed.ai.tools.summarize import AiSummarizeTool
