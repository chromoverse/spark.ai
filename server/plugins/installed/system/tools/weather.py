...
class WeatherCurrentTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Get current weather conditions at user location"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {
        "lat": {"type": "number", "required": False, "description": "Latitude — auto-detected from IP if omitted"},
        "lon": {"type": "number", "required": False, "description": "Longitude — auto-detected from IP if omitted"},
        "units": {"type": "string", "required": False, "default": "metric", "description": "metric or imperial"},
    }
    OUTPUT_SCHEMA: Dict[str, Any] = {
        "success": {"type": "boolean"},
        "data": {"location": {"type": "string"}, "temperature": {"type": "string"}, "feels_like": {"type": "string"}, "humidity": {"type": "string"}, "condition": {"type": "string"}, "wind_speed": {"type": "string"}, "wind_direction": {"type": "string"}, "uv_index": {"type": "number"}, "is_day": {"type": "boolean"}},
        "error": {"type": "string"},
    }
...
class WeatherForecastTool(BaseTool):
    """Get a multi-day weather forecast at a location."""

    TOOL_DESCRIPTION = "Get a multi-day weather forecast at user location"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {
        "lat": {"type": "number", "required": False, "description": "Latitude — auto-detected from IP if omitted"},
        "lon": {"type": "number", "required": False, "description": "Longitude — auto-detected from IP if omitted"},
        "days": {"type": "integer", "required": False, "default": 7, "description": "Number of forecast days, 1–16"},
        "units": {"type": "string", "required": False, "default": "metric", "description": "metric or imperial"},
    }
    OUTPUT_SCHEMA: Dict[str, Any] = {
        "success": {"type": "boolean"},
        "data": {"location": {"type": "string"}, "days_returned": {"type": "integer"}, "forecast": {"type": "array"}, "units": {"type": "string"}, "timestamp": {"type": "string"}},
        "error": {"type": "string"},
    }
