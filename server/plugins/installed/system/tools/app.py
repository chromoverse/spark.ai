...
class AppOpenTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Open local applications or websites based on user intent"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {
        "target": {"type": "string", "required": True},
        "destination": {"type": "string", "required": False, "default": "auto"},
        "web_fallback_policy": {"type": "string", "required": False, "default": "validate_then_ask"},
        "args": {"type": "array", "required": False},
    }
    OUTPUT_SCHEMA: Dict[str, Any] = {
        "success": {"type": "boolean"},
        "data": {"target": {"type": "string"}, "resolved_name": {"type": "string"}, "resolved_path": {"type": "string"}, "type": {"type": "string"}, "process_id": {"type": "integer"}, "launch_time": {"type": "string"}, "status": {"type": "string"}},
        "error": {"type": "string"},
    }
    EXAMPLES = [{"user_utterance": "open calculator", "inputs": {"target": "calculator", "destination": "auto"}}]
    SEMANTIC_TAGS = ["system", "app", "open"]
...
class AppCloseTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Kill running processes"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {"target": {"type": "string", "required": True}, "force": {"type": "boolean", "required": False, "default": False}}
    OUTPUT_SCHEMA: Dict[str, Any] = {"success": {"type": "boolean"}, "data": {"exit_code": {"type": "integer"}, "closed_at": {"type": "string"}}, "error": {"type": "string"}}
    EXAMPLES = [{"user_utterance": "close chrome"}]
    SEMANTIC_TAGS = ["system", "app", "close"]
    TOOL_CATEGORY = "system_control"
...
class AppRestartTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Restart apps safely"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {"target": {"type": "string", "required": True}, "save_state": {"type": "boolean", "required": False, "default": True}}
    OUTPUT_SCHEMA: Dict[str, Any] = {"success": {"type": "boolean"}, "data": {"old_process_id": {"type": "integer"}, "new_process_id": {"type": "integer"}, "restart_time": {"type": "string"}}, "error": {"type": "string"}}
    EXAMPLES = [{"user_utterance": "restart chrome"}]
    SEMANTIC_TAGS = ["system", "app", "restart"]
    TOOL_CATEGORY = "system_control"
...
class AppMinimizeTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Minimize application window"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {"target": {"type": "string", "required": True}}
    OUTPUT_SCHEMA: Dict[str, Any] = {"success": {"type": "boolean"}, "data": {"target": {"type": "string"}, "minimized": {"type": "boolean"}, "timestamp": {"type": "string"}}, "error": {"type": "string"}}
    EXAMPLES = [{"user_utterance": "minimize chrome"}]
    SEMANTIC_TAGS = ["system", "app", "minimize"]
    TOOL_CATEGORY = "system_control"
...
class AppMaximizeTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Maximize application window"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {"target": {"type": "string", "required": True}}
    OUTPUT_SCHEMA: Dict[str, Any] = {"success": {"type": "boolean"}, "data": {"target": {"type": "string"}, "maximized": {"type": "boolean"}, "timestamp": {"type": "string"}}, "error": {"type": "string"}}
    EXAMPLES = [{"user_utterance": "maximize chrome"}]
    SEMANTIC_TAGS = ["system", "app", "maximize"]
    TOOL_CATEGORY = "system_control"
...
class AppFocusTool(BaseTool):
    ...
    TOOL_DESCRIPTION = "Bring application to front and focus"
    EXECUTION_TARGET = "client"
    PARAMS_SCHEMA: Dict[str, Any] = {"target": {"type": "string", "required": True}}
    OUTPUT_SCHEMA: Dict[str, Any] = {"success": {"type": "boolean"}, "data": {"target": {"type": "string"}, "focused": {"type": "boolean"}, "timestamp": {"type": "string"}}, "error": {"type": "string"}}
    EXAMPLES = [{"user_utterance": "focus chrome"}]
    SEMANTIC_TAGS = ["system", "app", "focus"]
    TOOL_CATEGORY = "system_control"
