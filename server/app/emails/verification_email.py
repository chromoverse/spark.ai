...
# Usage example
def send(to_email: str, user_name: str, otp_code: str, login_url: str = "https://spark.ai/login", icon_url: Optional[str] = None):
    """
    ...
    """
    html_content = generate_verification_email(user_name, otp_code, login_url, icon_url = "https://res.cloudinary.com/dlrtkxkpg/image/upload/fl_preserve_transparency/v1764587833/icon-high-ql_srhpo8.jpg?_s=public-apps")
