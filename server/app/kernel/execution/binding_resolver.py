# app/kernel/binding_resolver.py
"""
...
from app.kernel.execution.execution_models import TaskRecord, ExecutionState
        ...
        for param_name, jsonpath_expr in task.task.input_bindings.items():
            try:
                ...
                if value is not None:
                    ...
                    logger.warning(f"  Binding returned None: {jsonpath_expr}")
