...
async def main():
    ...
    await config.update_user_details(
    ...
    user = await load_user("695e2bbaf8efc966aaf9f218")
    print("User details loaded:", user)
    ...
    doc = await config.get_last_n_messages("695e2bbaf8efc966aaf9f218",5)
