...
class ToolRegistryRuntimeTests(unittest.TestCase):
    def test_registry_validates_and_generated_index_matches_file(self):
        ...
        self.assertEqual(expected_index["total_tools"], 66)
        ...
        self.assertIn("artifact_resolve", index_names)
    ...
    def test_generated_files_are_in_sync(self):
        ...
        self.assertEqual(result["tool_count"], 68)
        self.assertEqual(result["index_tool_count"], 66)
        self.assertEqual(result["manifest_tool_count"], 66)
